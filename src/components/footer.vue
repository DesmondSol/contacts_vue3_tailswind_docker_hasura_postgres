...
<div class="mb-4 md:mb-0"><a class="hover:underline text-gray-600" href="https://www.figma.com/file/sjM0IkoSFRywXJwOjHbzjC/Page-viewer?node-id=0%3A1">Figma design</a>.</div>
    <div class="flex justify-center">
      ...
      <div class="w-8 ml-2 text-gray-500">
        <a href="http://www.github.com/DesmondSol" class="hover:text-gray-700">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current">
            <path
